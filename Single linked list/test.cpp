...
int main() {
  ...
  std::ifstream in;
  in.open("/Users/tonyvu/Library/Mobile Documents/com~apple~CloudDocs/Documents/Uni Assignments/Senior Year/CMSC 510/Single linked list/Single linked list/data.txt");
